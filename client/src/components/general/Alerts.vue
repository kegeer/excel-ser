...
<template>
  <div>
    ...
    <!-- Warning messages -->
    <div class="alert alert-warning" v-show="hasWarningMessage">
      <button type="button" class="close" aria-label="Close" @click="dismiss('warning')">
        <span aria-hidden="true">&times;</span>
      </button>
      {{ messages.warning }}
    </div>
    ...
    <div class="alert alert-warning" v-show="hasValidationMessages">
      ...
      <p class="text-warning">Something Wrong !</p>
      <!-- <ul>
